...
class FlappyBird:
    ...
    """
    Connect with drone until connected.
    """
    def drone_connect(self,port_name, drone_name):
        cnt = 0
        while(not self.drone.isConnected()) and cnt < 10:
            cnt += 1
            ...
            if (port_name is None):
                ...
                self.drone.connect(port_name, drone_name)
            sleep(5)
        ...
        while (self.quit is 0):
            ...
            while (self.cap.isOpened() and self.quit is 0):
                ...
                if (self.frame_cnt == 5):
                    ...
                    if self.drone.isConnected(): self.drone.sendControl(*self.get_control())
