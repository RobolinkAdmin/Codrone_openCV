...
# global variable
lowerThreshold = (160, 120, 120)
upperThreshold = (180, 255, 255)
h = 0
s = 0
v = 0
r = 0
...
if __name__ == '__main__':
    ...
    if drone.isConnected():
        ...
        '''
            ...
            cv2.putText(frame, format(time * 1000), (0, 20), font, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
            cv2.putText(frame, format(rad), (0, 80), font, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
            cv2.putText(frame, format(center), (0, 120), font, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
